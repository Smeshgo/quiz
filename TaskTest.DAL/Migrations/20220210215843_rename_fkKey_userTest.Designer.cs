...
namespace TaskTest.DAL.Migrations
{
    ...
    [Migration("20220210215843_rename_fkKey_userTest")]
    partial class rename_fkKey_userTest
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskTest.DAL.Entities.Answer", b =>
                {
            ...
            modelBuilder.Entity("TaskTest.DAL.Entities.Answer", b =>
                {
                    b.HasOne("TaskTest.DAL.Entities.Question", "Question")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("TaskTest.DAL.Entities.Question", b =>
                {
                    b.HasOne("TaskTest.DAL.Entities.Test", "Tests")
                        .WithMany("Questions")
